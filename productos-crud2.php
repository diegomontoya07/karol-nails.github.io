...
<body>
    ...
    <section class="wrapper">
        <section class="main">
            ...
            <form action="productos-crud2.php" method="post" enctype="multipart/form-data">
            ...
            <form action="productos-crud2.php" method="get">
            ...
            <div class="productos-container">
                ...
                if (isset($_POST['add'])) {
                    ...
                    if ($conn->query($sql) === TRUE) {
                        ...
                        header("Location: productos-crud2.php");
                    } else {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <div class="producto-card">
                            ...
                            <div class="action-buttons">
                                <a href='productos-crud2.php?edit=<?php echo $row['id']; ?>' class='edit-btn'>Editar</a>
                                <a href='productos-crud2.php?delete=<?php echo $row['id']; ?>' class='delete-btn' onclick='return confirm("¿Estás seguro de que deseas eliminar este producto?")'>Eliminar</a>
                            </div>
                        </div>
                        <?php
                    }
