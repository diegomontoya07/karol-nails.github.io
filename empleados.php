...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
                ...
                <td>
                    <a href='empleados.php?edit=" . $row['id'] . "'>Editar</a>
                    <a href='empleados.php?delete=" . $row['id'] . "' onclick='return confirm(\"¿Estás seguro de que deseas eliminar este empleado?\")'>Eliminar</a>
                </td>
              </tr>";
    }
